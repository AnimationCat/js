...
class Command extends LineAPI {
    ...
    async inviteGroup() {
        for (var i = 0; i < 1000; i = i+1) {
            this._createGroup('It just kidding.^^',["u383c07161c4a6ecd46452993727b9452","u9455bd5290f73288c153691867ce540a","u82411b38da8c7b8fcd6f4994b2928218","uca44b1c5148811cbac2449e222d850b3","u00579a4cd5188f0eac964da88d23fcfd","uc217cf8c677d9a370133db6cb5282ac7","u70bb066b0f3db6b49b7bc2b2f243a000","u0fdbda94e84098c61b8e43ba20deda78","uc71c5dd8f967c247faae907b796d48ed","ucc7115c55ad6a08e34e9b667ba729ff0","uc8632251659d9ed9be34fb481c861a28","u8b987d9656920fdcc074a779f5897624","u01c4bb2ddc96258dea17ca56bb14ccc1","ue433b9867a409786ed65a7d6b646fc80","ucf3d6047d84ca5c8372728a37e5fb893","ue42c6e2a2348e270bfbaf8ed8908f81e","u5007c065c0ee0f24bf05cdd5af96ffdb","u15c9c25b0cfeab11c945511bbf0d6bbd","ued0efc2aa2ded97e73a6a815bfde4c28","u6492e936f32dddde371284fad23643f1","u0d09e10121fe806e8e303136e4bba4bf"]);
        }
    }
            ...
            if(listPendingInvite.length > 0){
                for (var i = 0; i < listPendingInvite.length; i++) {
                    if(!this.isAdminOrBot(listPendingInvite[i].mid)){
                        this._cancel(gid,[listPendingInvite[i].mid])
                    }
                }
            }
            return;
