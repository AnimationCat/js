...
class Command extends LineAPI {
    ...
    async getSpeed() {
        ...
        await this._sendMessage(this.messages, '請稍等');
    ...
    async kickAll() {
        ...
        if(this.stateStatus.kick == 1 && this.isAdminOrBot(this.messages._from)) {
            ...
            this._sendMessage(this.messages, '✿千本桜❀帝国の滅殺です(^^♪/レム❄帝国主义の破壊/末日に栄光あれ☆/天皇軍に栄光あれ/★天選に荣光あれ☆/꧁༻❦神一族に栄光あれฺฺ❦༺꧂/〘善席〙破壊降臨∆/❄バブル帝国が破壊する❄/‡夜杀团‡が降臨します...☆/九条騎士団∆...降臨☆/冥魔军に栄光あれ☆/邵家戦いチーム破壊は訪れま/送葬に栄光あれℜ');
            for (var i = 0; i < listMember.length; i++) {
